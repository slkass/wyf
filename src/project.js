  ...
  GameUiTools: [function (e, t, n) {
    ...
    var o = {
      newSprite: function (e, t) {
        var n = new cc.Node;
        return t ? (e = e.split(".")[0], n.addComponent(cc.Sprite).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(e)) : n.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame("https://cdn.jsdelivr.net/gh/slkass/wyf/res/raw-assets/resources/" + e), n
      },
